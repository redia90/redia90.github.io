...
## ASCO 2026 후 서브타입 분류 갱신 (2026-06)

### HER2-low / ultralow 분류 확장 — DESTINY-Breast06 (NEJM 2024) 후속

DESTINY-Breast06 후속 + ASCO 2026 데이터 — HER2-low 1차 ADC 도입과 함께 분류 정밀도 ↑:

| 분류 | IHC | FISH | 한국 임상 (2026-06) |
|------|-----|------|------------------------|
| **HER2 양성** | 3+ 또는 2+/FISH+ | + | [[treatment-systemic/HER2표적치료|허셉틴·퍼투주맙·T-DXd·T-DM1]] 표준 |
| **HER2-low** | 1+ 또는 2+/FISH- | - | [[treatment-systemic/HER2-low치료|엔허투]] 2차+ 표준, **1차 도입 진행** (DESTINY-Breast06 한국 보험 검토) |
| **HER2-ultralow** | 0이지만 일부 염색 | - | 엔허투 적응증 확대 (FDA 2024-05, 한국 비급여) — 2027~ 보험 평가 |
| **HER2 0** | 완전 음성 | - | 기존 치료 흐름 |

> 💡 **2026 갱신 포인트**: HER2-low/ultralow 분류는 **DESTINY-Breast06 (전이성 1차) 진입** + **디지털 병리 AI (Paige·Lunit SCOPE) HER2 0/1+ 경계 판독 정확도 ↑**로 임상 결정 도구로 확립 중. → [[diagnosis-imaging/유방암AI영상|디지털 병리 AI]] · [[diagnosis-tests/조직검사결과해석]] 통합 확인.

### LINUXtrial AI subtype (SNF1~4) — 2026 후속 진행

CDK4/6 진행 후 HR+/HER2- 전이성에서 ASCO 2026·SABCS 2025 잠정 보고:
- **SNF2 (면역 풍부)**: 면역치료 (펨브로·아테졸리주맙) 반응 시사
- **SNF4 (표적 약제 반응)**: PI3K/AKT (capivasertib·inavolisib) 적응증 후보
- **SNF1·SNF3**: 표준 vepdegestrant·다음 단계 약제
- **PROBES·VICTORIAN 3상** 진행 중 — 2027~2028 결과 예상

### Claudin-low TNBC — 면역치료 반응 (2026-06)

[[research/2026임상연구업데이트|KEYNOTE-355 사후 분석]]:
- Claudin-low TNBC는 TIL·PD-L1 발현 ↑ → **면역치료 반응 우수**
- 별도 적응증 미확립 — 임상 진료에서는 PD-L1 CPS로 결정
- **단일세포 RNA-seq** (Nat Commun 2024)에서 Prrx1+ 중간 발현 세포 (전이 위험) 풍부

### 재발·전이 시 서브타입 전환 (20~30%) — 2026 모니터링

[[research/2026임상연구업데이트|JNCI 2024 메타분석]] 재발 병소 재조직검사:
- ER 전환: 13%
- PR 전환: 32%
- **HER2 전환**: 11~28% (특히 HER2 0/1+ 경계 환자에서 ↑)
- **표준**: 전이 의심 시 재조직검사
- **ctDNA 동반**: ESR1·HER2·BRCA reversion·PIK3CA 변이 검출 → [[research/전이메커니즘_Prrx1|MRD 모니터링 통합]]

### PAM50 한국 도입 (2026-06)

- **Prosigna** (PAM50 ROR) — 일부 대형 병원 (삼성·서울대·아산) 비급여 약 100~150만 원
- **Oncotype DX vs Prosigna vs MammaPrint** — 한국 KBCS 권고: Oncotype DX 보험 적용 + Prosigna 옵션
- **2027~2028 보험 확대** 평가 진행 (심평원)
- → [[diagnosis-tests/유전자발현프로파일링|5종 검사 통합]]
...
- [[조직검사결과해석]] — **결과지 ER/PR/HER2/Ki-67 → 서브타입 결정 (HER2 IHC 0/1+ 경계 디지털 병리 AI 판독) 양방향 핵심 cross-link**
...
- [[research/전이메커니즘_Prrx1]] — **서브타입별 Prrx1 발현·EMT·전이 경로 차이 (TNBC·Basal-like ↑) — 분자 전이 기전과 서브타입 통합**
- [[diagnosis-imaging/유방영상검사가이드]] — **디지털 병리 AI HER2 0/1+ 경계 판독 → HER2-low/ultralow 분류 정확도 직결**
- [[mental-experience/처음온사람안내]] — **진단 직후 환자가 ER·PR·HER2·Ki-67 결과지 이해 첫 단계 — 서브타입 분류 입구**
- [[diagnosis-workflow/검사결과지읽기도우미]] — **결과지 항목별 (병기·수용체·등급) 해석 → 서브타입 결정 흐름**
...
- 2026-06-15: **ASCO 2026 후 서브타입 분류 갱신** 섹션 신규 (library-check Top 1 — hub 페이지 incoming 32 파급) — HER2-low/ultralow 분류 확장 (DESTINY-Breast06 1차 도입·디지털 병리 AI 정확도 ↑), LINUXtrial AI subtype 2026 후속 (SNF2 면역치료·SNF4 PI3K/AKT), Claudin-low TNBC 면역치료 반응, 재발 시 서브타입 전환 (20~30%) ctDNA 모니터링, PAM50 한국 도입 (Prosigna 비급여→2027~2028 보험 평가)
