...
- [[2026임상연구업데이트]] — **DESTINY-Breast06 (HER2-low 1차) 도입 압력과 디지털 병리 AI HER2 IHC 0/1+ 경계 정확도 연계 — 핵심 cross-link**
...
- 2026-06-02: **Q2 2026 한국 AI 영상 적용 갱신** 섹션 신규 (보강 추천 Top 3) — 루닛 INSIGHT 시리즈 4종 도입 변화 (MMG 15~20%·DBT 50개+·SCOPE PD-L1/HER2 대형 병원 확대), MASAI 후속 AI 단독 판독 논의·한국 영향 (KSBI 권고안 진행), KoBCRA 한국형 위험 평가 검증 진행 (Tyrer-Cuzick·NCCN·Lunit 비교), 디지털 병리 AI HER2-low/ultralow 정확도 (DESTINY-Breast06 도입 압력과 동반), 환자 진료실 질문 추가 (HER2 IHC 0/1+ 경계·PD-L1 CPS AI 재판독)
